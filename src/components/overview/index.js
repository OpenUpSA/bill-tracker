...
function Overview() {
  ...
  const [_historicalData_allParties, setHistoricalData_allParties] = useState([]);
  const [filteredQuestionsData, setFilteredQuestionsData] = useState([]);
  const [_filteredQuestionsData_allParties, setFilteredQuestionsData_allParties] = useState([]);
      ...
      <Container fluid className="pt-4">
        <div className="overview-container">
          <Row>
            ...
            <Col xs="auto">
              <div className="badge text-bg-dark py-1 px-2">Data till 31 August 2025</div>
            </Col>
          </Row>
        </div>
      </Container>
